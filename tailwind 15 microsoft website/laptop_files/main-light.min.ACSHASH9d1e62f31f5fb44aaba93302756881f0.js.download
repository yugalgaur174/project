	...
	*/
	...
	class ComboboxSelect {
	  ...
	  constructor(_ref) {
	    ...
	    this.comboboxText = document.querySelector(Selector$i.DATA_TEXT);
	  ...
	  if (this.inCustomViewport()) {
	    ...
	    imagesloadedExports(this.el, () => {
	      ...
	      this.collapses.forEach((c, i) => {
	        ...
	        const dNone = c.feature.classList.contains(ClassName$7.DISPLAY.NONE);
